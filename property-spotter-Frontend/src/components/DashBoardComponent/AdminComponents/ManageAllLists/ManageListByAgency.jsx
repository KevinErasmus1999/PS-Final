      ...
      <div className="flex justify-end">
        <div className="flex items-center justify-center gap-2 py-2">
          ...
          >
            ...
            <option value="sold, spotter paid">Sold, Spotter paid</option>
          </select>
          <button
        ...
        <div className="overflow-x-auto">
          <table className="table w-full">
            ...
            <tbody className="text-center">
              {currentJobs
                .filter((item) => item.agency.some((name) => name !== "admin"))
                .filter((house) =>
                  filterValue ? house.status === filterValue : house
                )
                .map((house, index) => (
                  <tr key={house?._id}>
                    ...
                    <td>
                      <button
                        className="btn btn-primary"
                        onClick={() => handleUnassigned(house._id)}
                      >
                        Unassign
                      </button>
                    </td>
